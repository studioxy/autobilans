...
def test_load_xml_aliases_reads_config_file() -> None:
    aliases = load_xml_aliases(r"D:\autobilans\config\xml_aliases.yaml", company="8spzoo", year=2025)
...
def test_load_xml_aliases_merges_company_scope() -> None:
    aliases = load_xml_aliases(r"D:\autobilans\config\xml_aliases.yaml", company="oksanbud", year=2025)
